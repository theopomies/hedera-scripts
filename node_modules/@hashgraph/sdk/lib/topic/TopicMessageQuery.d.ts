...
export default class TopicMessageQuery {
     ...
     */
    subscribe(client: import("../client/Client.js").default<any, import("../channel/MirrorChannel.js").default>, errorHandler: ((message: TopicMessage, error: Error) => void) | null, listener: (message: TopicMessage) => void): SubscriptionHandle;
    /**
     * @private
