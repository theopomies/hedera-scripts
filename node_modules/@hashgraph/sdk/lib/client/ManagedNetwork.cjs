...
var _NetworkName = require("../NetworkName.cjs");
...
class MangedNetwork {
  ...
  setTransportSecurity(transportSecurity) {
    if (this._transportSecurity != transportSecurity) {
      ...
      for (let i = 0; i < this._nodes.length; i++) {
        ...
        node =
        /** @type {NetworkNodeT} */
        transportSecurity ? node.toSecure().setCert(this._ledgerId != null ? this._ledgerId : "") : node.toInsecure();
        this._nodes[i] = node;
  ...
  setNetworkName(networkName) {
    this._ledgerId = (0, _NetworkName._ledgerIdToLedgerId)(networkName);
    return this;
  }
  /**
   * @returns {string | null}
  ...
  get networkName() {
    return this._ledgerId != null ? (0, _NetworkName._ledgerIdToNetworkName)(this._ledgerId) : null;
  }
  /**
   * @abstract
