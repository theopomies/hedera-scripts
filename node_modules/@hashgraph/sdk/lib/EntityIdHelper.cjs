...
function constructor(props, realm, numOrAliasKey) {
  ...
  if (numOrAliasKey instanceof _PublicKey.default) {
  ...
  if (typeof props === "number" || _long.default.isLong(props)) {
    if (realm == null || typeof realm === "string") {
      ...
      num_ = numOrAliasKey != null && !(numOrAliasKey instanceof _PublicKey.default) ? _long.default.fromValue(numOrAliasKey) : _long.default.ZERO;
    }
  } else {
